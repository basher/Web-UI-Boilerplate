...
### Web components
- The JavaScript-enhanced components are in the process of being converted into their equivalent [HTML Web Components](/docs/web-components-or-custom-elements-using-web-components--docs).
