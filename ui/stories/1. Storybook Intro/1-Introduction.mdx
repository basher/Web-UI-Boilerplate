...
### 2. In Storybook
- Uses the [storybook-theme-switch-addon](https://www.npmjs.com/package/storybook-theme-switch-addon).
> NOTE: This addon has been temporarily disabled in [Storybook 10 due to compatibility issues](https://github.com/krzysztof01-sz/storybook-theme-switch-addon/issues/7).
