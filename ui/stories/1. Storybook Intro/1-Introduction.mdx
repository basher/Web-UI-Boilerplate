...
### 2. In Storybook
> When running Storybook locally, theme switching is only possible if CSS themes have been bundled via `npm run bundle-all-themes`. This happens automatically in the published Storybook.
