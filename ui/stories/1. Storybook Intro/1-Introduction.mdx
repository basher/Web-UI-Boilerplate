...
- `Vitest addon`. See [official docs](https://storybook.js.org/docs/writing-tests/accessibility-testing#run-accessibility-tests).
    ...
    - It can also be run from the CLI. `cd ui` then `npm run test-storybook`.

> NOTE: I have raised a [Github issue for Vitest](https://github.com/storybookjs/storybook/issues/34613), and [another issue for addon-a11y](https://github.com/storybookjs/storybook/issues/34647).
