...
- Images are [lazy loaded](https://developer.mozilla.org/en-US/docs/Web/Performance/Lazy_loading), but be aware of [not lazy loading images above the fold](https://web.dev/articles/browser-level-image-lazy-loading#eager-load-first-images).
...
<Canvas of={Images.FixedSizeImage} />
