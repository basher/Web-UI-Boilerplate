...
- Use JavaScript to make a standard card clickable. See [make clickable utility](/story/utilities-helpers-and-utilities--make-clickable).
...
<Canvas of={CardsNoArgs.CardSlider} />
