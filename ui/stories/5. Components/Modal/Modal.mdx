...
Attribute | Behaviour
--- | ---
`command` | Required. On the button that opens the modal dialog.
`commandfor` | Required. On the button that opens the modal dialog. This is a reference to the modal's `id`.
