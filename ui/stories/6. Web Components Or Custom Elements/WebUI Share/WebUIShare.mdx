...
# `<webui-share>`
- Shares the current page's URL, leveraging the [Web Share API](https://developer.mozilla.org/en-US/docs/Web/API/Navigator/share).
...
- Shares another URL (e.g. inside a card).
