...
<input type="email" id="input-email" class="input" placeholder="email@domain.com" autocomplete="email" ${
    args.disabled === true ? 'disabled' : ''
} />
`;
...
<input type="tel" id="input-tel" class="input" pattern="^[0-9-+\s()]*$" placeholder="tel number, including +-() and spaces" autocomplete="tel" ${
    args.disabled === true ? 'disabled' : ''
} />
`;
